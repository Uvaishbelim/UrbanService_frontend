  ...
  return (
    <div className="col-12 mt-4">
      ...
      <div className="mb-5 ps-3">
        <h4
          className="mb-1 font-weight-bolder"
      ...
      <div className="row">
        {bookings?.map((booking) => {
          return (
            <div
              className="col-xl-3 col-md-6 mb-xl-0 mb-5"
              style={{ width: "425px", marginInlineStart: "15px" }}>
              <div className="card card-blog card-plain">
                ...
                <div className="card-body p-3">
                  <p className="mb-0 text-sm">
                    <h6> Service Id :</h6>
                    {booking?.serviceId}.<br></br>
                    <h6>Service-Provider Id :</h6> {booking?.serviceprovider}.
                    <br></br>
                    <h6>totalAmount :</h6>
                    {booking?.totalAmount}.<br></br>
